...
export default function Spinner() {
  ...
  return (
    <div className='widget-spinner container'>
      ...
      {
        spinner
        ?<button id='toggleSpinner' onClick={toggleSpinner}>Hide Spinner</button>  //Spinner = True 
        :<button id='toggleSpinner' onClick={toggleSpinner}>Show Spinner</button>  //Spinner = False 
      }
    </div>
  );
}
